...
public class TestVentana extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        iFieldCondiciones = new javax.swing.JTextField();
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, fieldCrearTablaCLayout.createSequentialGroup()
                        ...
                        .addGroup(fieldCrearTablaCLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(fieldCrearTablaCLayout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(iFieldCondiciones, javax.swing.GroupLayout.PREFERRED_SIZE, 56, javax.swing.GroupLayout.PREFERRED_SIZE))))
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, fieldCrearTablaCLayout.createSequentialGroup()
                        .addGap(18, 18, 18)
        ...
        fieldCrearTablaCLayout.setVerticalGroup(
            ...
            .addGroup(fieldCrearTablaCLayout.createSequentialGroup()
                ...
                .addGroup(fieldCrearTablaCLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(iFieldCondiciones, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(30, 30, 30)
                .addGroup(fieldCrearTablaCLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void btnIngresarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnIngresarMouseClicked
        ...
        String cond = iFieldCondiciones.getText();
    ...
    private void btnActualizarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnActualizarMouseClicked
        ...
        try {
            if (apellido.isEmpty()) {
                GestionDePersonal.getConexionDB().actualizar(tabla, "Nombre='" + nombre + "'", "Id=" + iD);
            } else if (nombre.isEmpty()) {
                GestionDePersonal.getConexionDB().actualizar(tabla, "Apellido='" + apellido + "'", "Id=" + iD);
            } else {
                GestionDePersonal.getConexionDB().actualizar(tabla, "Nombre='" + nombre + "', Apellido='" + apellido + "'", "Id=" + iD);
    ...
    private javax.swing.JTextField iFieldCondiciones;
